...
class FAQ extends Component {
    ...
    toggleAccordion = (index, event) => {
        ...
        if (collapseElement) {
            if (this.state.activeIndex === index) {
                ...
                const currentOpen = document.getElementById(`faqCollapse${this.state.activeIndex}`);
    ...
    render() {
        ...
        return (
            <section id="faq" className="pt100 pb100" style={{backgroundColor: 'rgb(19, 19, 19)'}}>
                <div className="container">
                    <div className="row">
                        <div className="col-lg-8 col-md-10 offset-lg-2 offset-md-1">
                            <div className="section-title text-center mb60">
                                <h2 dangerouslySetInnerHTML={{__html: getSectionHeading.title}} style={{color: '#ed4425'}}></h2>
                                <hr className="lines"/>
                            ...
                            <div id="faq-accordion">
                                {
                                    getAccordionContent.map((element, i) => {
                                        ...
                                        return (
                                            <div key={i} className="card mb15" style={{
                                                border: '1px solid #333',
                                                borderRadius: '10px',
                                                overflow: 'hidden',
                                                backgroundColor: '#181818'
                                            }}>
                                                <div className="card-header" id={`faqHeading${i}`} style={{
                                                    backgroundColor: '#181818',
                                                    ...
                                                    <h5 className="mb-0">
                                                        ...
                                                        >
                                                            ...
                                                            <i className={`fa fa-chevron-${isActive ? 'up' : 'down'}`} style={{
                                                                color: '#ed4425',
